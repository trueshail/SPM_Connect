CREATE TABLE [dbo].[WOInOut] (
    ...
    [WO]                 INT      NOT NULL,
    [Emp_idCheckOut]     INT      CONSTRAINT [DF_WOInOut_Emp_idCheckOut] DEFAULT ((0)) NOT NULL,
    [Emp_idCheckIn]      INT      CONSTRAINT [DF_WOInOut_Emp_idCheckIn] DEFAULT ((0)) NOT NULL,
    [PunchIn]            DATETIME NULL,
    [PunchOut]           DATETIME NULL,
    [TimeElapsed]        DATETIME NULL,
    [CheckOutApprovedBy] INT      CONSTRAINT [DF_WOInOut_CheckOutApprovedBy] DEFAULT ((0)) NOT NULL,
    [CheckInApprovedBy]  INT      CONSTRAINT [DF_WOInOut_CheckInApprovedBy] DEFAULT ((0)) NOT NULL,
