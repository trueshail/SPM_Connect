...
namespace SearchDataSPM.WorkOrder
{
    public partial class BinLog : Form
    {
        ...
        {
            _ = new DataTable();
            DataTable dtb1 = connectapi.ShowWOtrackingProg(wo);
            ...
            if (r["Engin"].ToString() == "1")
            {
                ...
                {
                    prodwaiting.BackColor = r["Engin"].ToString() == "1" && r["Prodin"].ToString() == "1" ? Color.Green : Color.Red;
                }
            }
            else if (r["Ctrlin"].ToString() == "1")
            {
                ...
                {
                    prodwaiting.BackColor = r["Ctrlin"].ToString() == "1" && r["Prodin"].ToString() == "1" ? Color.Green : Color.Red;
                }
            }
            else
            {
            ...
            else
            {
                ...
                purwait.BackColor = r["Prodout"].ToString() == "1" ? Color.Yellow : Color.Red;
            ...
            else
            {
                ...
                cribwait.BackColor = r["Prodout"].ToString() == "1" ? Color.Yellow : Color.Red;
        ...
        {
            _ = new DataTable();
            DataTable dtb1 = connectapi.ShowWODetails(wo);
            ...
            if (dtb1.Rows.Count > 0)
            {
                ...
                loclbl.Text = "Location : " + (r["Location"].ToString() ?? "");
        ...
        private void PopulateWorkOrders()
        {
            ...
            _ = new DataTable();
            DataTable workorderlist = connectapi.ShowDistinctWO();
