...
namespace SearchDataSPM.General
{
    public partial class ServiceReportHome : Form
    {
        ...
        private readonly Service connectapi = new SPMConnectAPI.Service();
        ...
        private void FilterProducts()
        {
            if (!formloading)
            {
                ...
                if (jobnumbercombobox.Text.Length > 0)
                {
                    ...
                    {
                        //filter += "AND";
                        filter += string.Format("AND [Job No] = '{0}'", jobnumbercombobox.Text);
                    }
                    else
                    {
                        filter += string.Format("[Job No] = '{0}'", jobnumbercombobox.Text);
                    }
                }
                if (projectmangercombobox.Text.Length > 0)
                {
                    ...
                    {
                        //filter += "AND";
                        filter += string.Format(" AND ProjectManager = '{0}'", projectmangercombobox.Text);
                    }
                    else
                    {
                        filter += string.Format("ProjectManager = '{0}'", projectmangercombobox.Text);
                    }
                }
                if (authorizedbycombo.Text.Length > 0)
                {
                    ...
                    {
                        //filter += "AND";
                        filter += string.Format(" AND Authorizedby = '{0}'", authorizedbycombo.Text);
                    }
                    else
                    {
                        filter += string.Format("Authorizedby = '{0}'", authorizedbycombo.Text);
                    }
                }
                if (customercomboxbox.Text.Length > 0)
                {
                    ...
                    {
                        //filter += "AND";
                        filter += string.Format(" AND Customer = '{0}'", customercomboxbox.Text);
                    }
                    else
                    {
                        filter += string.Format("Customer = '{0}'", customercomboxbox.Text);
                    }
                }
                if (technamecomboxbox.Text.Length > 0)
                {
                    ...
                    {
                        //filter += "AND";
                        filter += string.Format(" AND [Tech Name] LIKE '%{0}%'", technamecomboxbox.Text);
                    }
                    else
                    {
                        filter += string.Format("[Tech Name] LIKE '%{0}%'", technamecomboxbox.Text);
                    }
                }
                if (refjobcombobox.Text.Length > 0)
                {
                    ...
                    {
                        //filter += "AND";
                        filter += string.Format(" AND RefJob  LIKE '%{0}%'", refjobcombobox.Text);
                    }
                    else
                    {
                        filter += string.Format("RefJob  LIKE '%{0}%'", refjobcombobox.Text);
                    }
                }
                if (equipmentcomboBox.Text.Length > 0)
                {
                    ...
                    {
                        //filter += "AND";
                        filter += string.Format(" AND Equipment LIKE '%{0}%'", equipmentcomboBox.Text);
                    }
                    else
                    {
                        filter += string.Format("Equipment LIKE '%{0}%'", equipmentcomboBox.Text);
                    }
                }
