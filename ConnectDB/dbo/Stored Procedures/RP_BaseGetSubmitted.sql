...
-- Description:	Get the customized list of releases of the sumbit user
-- =============================================
CREATE PROCEDURE [dbo].[RP_BaseGetSubmitted]
...
BEGIN
	...
	WHERE rb.IsActive = '1'
	AND rb.CreatedById = @CreatorId
	AND rb.SubAssy = @SubAssy
	AND rb.IsSubmitted = '0'
